...
* Introduction
  ...
  enjoy the content in less time. The git repo is at
  https://github.com/kidd/scripting-field-guide/ and both contents,
  order and wording are WIP. Any feedback is greatly appreciated.
