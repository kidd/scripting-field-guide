...
** array of callbacks on_exit
   Level up that pattern, we can have a helper to add callbacks to run on exit.
...
* from shell to lisp and everything in between
  ...
  - bocker
* Credits
  - Raimon Grau <raimonster@gmail.com> did the writing.
  - Most examples are result of Raimon's and Lluís
