...
* Introduction
  ...
  probably started as one-off scripts, and probably later on started
...
** Pass Arrays around
   ...
   Read the great Oil Shell [[http://www.oilshell.org/blog/2016/11/06.html][blogpost]].
** Slurping arrays
...
** Read lines from file
   ...
   More related info in the [[https://mywiki.wooledge.org/BashFAQ/001][BashFAQ001]].
** Assign to $1,$2,$3...
...
** HERESTRINGS
   It's the next level from HEREDOCS. Inline a string as a file.
...
** make noglob 'transparent' to bash
   ...
   supported in bash. =noglob= is one of them. To build a cushion
