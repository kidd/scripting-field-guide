...
* from shell to lisp and everything in between
  ...
  - bocker
* make zsh/bash scripts more compatible
...
* Credits
  Raimon Grau <raimonster@gmail.com> did the writing and most examples
  with some help and inspiration from Lluís Eskerda
  <eskerda@gmail.com>. nikisweeting provided some very nice examples
  in this HN therad https://news.ycombinator.com/item?id=24402571.
